...
var chats = new Firebase("https://inabachattr.firebaseio.com/familia");
var users = new Firebase("https://inabachattr.firebaseio.com/users");

var username, userId, newUser, avatar = false, lastDate, messagesLoaded = false, usersLoaded;
var $$ = Dom7;
...
var mainView = chattr.addView('.view-main', {
    domCache: true //enable inline pages
});

var myMessages = chattr.messages('.messages', {
    autoLayout: true
});
...
function loadMessages(snapshot) {
    ...
    for (messageId in messages) {
        ...
        if (localStorage.username === message.name) {
